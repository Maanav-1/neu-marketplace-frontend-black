    ...
    <div className="flex flex-col justify-center items-center min-h-[80vh] px-4">
      ...
      >
        ...
        <Card className="border-zinc-800 bg-zinc-950/50 backdrop-blur-xl shadow-2xl">
          ...
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-2">
                {/* Changed label text as requested */}
                ...
                <div className="relative">
                  ...
                  <Input 
                    type="email" 
                    placeholder="husky.j@northeastern.edu" 
                    value={email} 
                    onChange={(e) => setEmail(e.target.value)} 
                    className="bg-zinc-900 border-zinc-800 pl-10 h-12 focus:ring-blue-500 transition-all" 
                    required 
                  />
                </div>
              </div>
              ...
              <Button 
                type="submit" 
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold h-12 rounded-xl mt-2 shadow-lg shadow-blue-500/20 transition-all" 
                disabled={loading}
              >
                {loading ? (
          ...
          <CardFooter className="flex flex-col border-t border-zinc-900 pt-6">
